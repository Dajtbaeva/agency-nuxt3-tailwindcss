<template>
  <section class="lg:mx-desktop bg-[#f3f7f5] rounded-3xl mt-4 relative">
    ...
    >
      <img src="/stat.png" alt="img" class="mx-auto" />
      <p>80% startups</p>
    ...
    <div class="flex">
      <div class="basis-1/2 pl-20 pt-24 relative">
        ...
        >
          <div
            class="absolute right-[20%] top-0 rounded-full w-5 h-5 bg-green-500/50"
          ></div>
          Join the world's <br />
          largest startup <br />
          community
        ...
        <div class="mt-16">
          <NuxtLink
            to="#"
            class="border border-transparent hover:border-[#3e3e3e] hover:bg-[#3e3e3e] py-5 px-10 rounded-full font-medium bg-black text-white transition-all"
      ...
      <div class="basis-1/2 overflow-hidden relative hidden lg:block">
        ...
        <div class="absolute top-1/2 right=[10%]">
          <div
            class="flex relative p-2 rounded-full bg-white w-80 cursor-pointer hover:scale-105 transition-all duration-300"
          >
            <!-- Heart -->
            <div
              class="right-5 -top-5 p-2 h-11 w-11 bg-gradient-to-br from-red-100 via-red-500 to-red-600 rounded-full shadow-lg shadow-red-500"
            >
            ...
            <p class="text-lg font-medium text-gray-600 mx-4">
              <span class="font-bold text-black">Mickey</span> has liked <br />
              this community
            </p>
          </div>
        </div>
        <img src="/home.png" alt="img" class="object-cover h-[100$]" />
      </div>
    </div>
  </section>
</template>
