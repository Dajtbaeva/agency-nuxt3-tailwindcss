<template>
  <header
    class="flex items-center justify-between py-7 lg:px-desktop mx-auto sticky top-0 bg-white/80"
  >
    <NuxtLink to="/">
    ...
    <ul class="lg:flex hidden items-center space-x-14">
      ...
      >
        ...
        <div
          ...
          class="h-0.5 mt-0.5 group-hover:scale-y-100 group-hover:bg-black group-hover:blobk w-[80%] transition-all duration-300"
        ></div>
      </li>
    </ul>
